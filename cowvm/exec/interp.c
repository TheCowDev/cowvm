...
CowInterpValue eval_func(CowFunc func, CowInterpValue *values) {
    ...
    static void *dispatch_table[] = {
            NULL,
            &&L_COW_OPCODE_CONST_I128,
            &&L_COW_OPCODE_CONST_I64,
            &&L_COW_OPCODE_CONST_I32,
            &&L_COW_OPCODE_CONST_I16,
            &&L_COW_OPCODE_CONST_I8,
            &&L_COW_OPCODE_CONST_PTR,
            ...
            &&L_COW_OPCODE_DIFF,
            &&L_COW_OPCODE_LARGER,
            &&L_COW_OPCODE_LARGER_EQ,
            &&L_COW_OPCODE_SMALLER,
            &&L_COW_OPCODE_SMALLER_EQ,
            ...
            &&L_COW_OPCODE_BR,
            &&L_COW_OPCODE_COND_BR,

            &&L_COW_OPCODE_CALL_PTR,
            &&L_COW_OPCODE_CALL_FUNC,

            &&L_COW_OPCODE_RET,
            &&L_COW_OPCODE_RET_VOID
    };


#define DISPATCH() goto *dispatch_table[current_instr->opcode];
#define NEXT_INSTR()  goto INCREMENT_INSTR_BLOCK;
